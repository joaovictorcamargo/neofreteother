...
var UpdateCarryingController = /** @class */ (function () {
    function UpdateCarryingController() {
    }
    UpdateCarryingController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id, typeOfPerson, cnpj, stateRegistration, socialReason, fantasyName, cep, street, number, neighborhood, city, state, email, phone, Observation, updateCarrying;
    ...
    return UpdateCarryingController;
}());
exports.UpdateCarryingController = UpdateCarryingController;
//# sourceMappingURL=UpdateCarryingController.js.map